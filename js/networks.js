...
async function addAvaxNetwork(){
  const chainID = 43114;
  const chainName = "Avalanache Mainnet";
...
async function addFtmNetwork(){
  const chainID = 250;
  const chainName = "Fantom Opera";
  const currencyName = "Fantom";
  const currencySymbol = "FTM";
  const rpcUrl = "https://rpc.ftm.tools/";
  const blockExplorerUrl = "https://ftmscan.com/";
  await Moralis.addNetwork(chainID, chainName, currencyName, currencySymbol, rpcUrl, blockExplorerUrl);
...
async function addOecNetwork(){
  const chainID = 66;
  const chainName = "OKExChain Mainnet";
  const currencyName = "OKT";
  const currencySymbol = "OKT";
...
async function addHecoNetwork(){
  ...
  const currencyName = "Huobi Token";
...
async function addOneNetwork(){
  ...
  const currencyName = "Harmony";
  const currencySymbol = "ONE";
  const rpcUrl = "https://api.harmony.one";
  const blockExplorerUrl = "https://explorer.harmony.one/";
  await Moralis.addNetwork(chainID, chainName, currencyName, currencySymbol, rpcUrl, blockExplorerUrl);
...
async function addOpNetwork(){
  const chainID = 10;
  const chainName = "Optimistic Mainnet";
  const currencyName = "Ethereum";
  const currencySymbol = "ETH";
  const rpcUrl = "https://mainnet.optimism.io/";
  const blockExplorerUrl = "https://optimistic.etherscan.io/";
  await Moralis.addNetwork(chainID, chainName, currencyName, currencySymbol, rpcUrl, blockExplorerUrl);
}

async function addHooNetwork(){
  const chainID = 70;
  const chainName = "Hoo Smart Chain";
  const currencyName = "Hoo Token";
  const currencySymbol = "HOO";
  const rpcUrl = "https://http-mainnet.hoosmartchain.com/";
  const blockExplorerUrl = "https://hscscan.com/";
  await Moralis.addNetwork(chainID, chainName, currencyName, currencySymbol, rpcUrl, blockExplorerUrl);
