    ...
    .then(data => {
        ...
        data.forEach(tc =>{
            ...
            <tr>
                ...
                <div class="d-flex px-3 py-1">
                    <div class="d-flex alig flex-column justify-content-center">
                        <div class="icon icon-shape icon-sm text-center border-radius-lg me-0">
                            <img src="${tc.top_3_coins[0]}" style="width: 25px;" class="mt-1" alt="Top Coin 1">
                            <img src="${tc.top_3_coins[1]}" style="width: 25px;" class="mt-1" alt="Top Coin 2">
                            <img src="${tc.top_3_coins[2]}" style="width: 25px;" class="mt-1" alt="Top Coin 3">
                        </div>
                    </div>
                </div>
                </td>
