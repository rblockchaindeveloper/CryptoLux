...
function getBscPadProjects(){
    try{
        fetch('https://tronpad.network/api/projects')
                    ...
                    <div class="card h-60">
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="row justify-content-md-center mt-2">
                                ${data[i].state == "C" ? `<span class="badge bg-gradient-danger col-11">დამთავრებულია</span>` : `<span class="badge bg-gradient-success col-11">TBA</span>`}
                            </div>
                        </div>
                    </div>
                </div>
