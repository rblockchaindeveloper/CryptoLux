...
function getBscPadProjects(){
    try{
        fetch('https://app-ethpad.network/api/projects')
                        ...
                        <div class="card-body p-3">
                            <ul class="list-group">
                                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                                    <div class="me-2">
                                        <img src="${data[i].logo}" style="width: 40px;" alt="">
                                    </div>
                                    <div class="d-flex align-items-start flex-column justify-content-center">
                                        <h6 class="mb-0 text-sm">${data[i].name}</h6>
                                        <div class="d-flex">
                                            <a target="_blank" href="${data[i].website}"><p class="mb-0 text-sm me-1" style="cursor: pointer;"><i class="fas fa-globe"></i></p></a>
                                            <a target="_blank" href="${data[i].twitter}"><p class="mb-0 text-sm me-1" style="cursor: pointer;"><i class="fab fa-twitter"></i></p></a>
                                            <a target="_blank" href="${data[i].telegram}"><p class="mb-0 text-sm me-1" style="cursor: pointer;"><i class="fab fa-telegram"></i></p></a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="text-sm text-bold text-dark"> 1 ${data[i].symbol} = ${data[i].rate} ${data[i].projectTokenSymbol}</div>
                            <div class="row justify-content-md-center mt-2">
                                ${data[i].totalCountUserParticipated > 0 ? `<span class="badge bg-gradient-danger col-11">დამთავრებულია</span>` : `<span class="badge bg-gradient-success col-11">TBA</span>`}
                            </div>
                        </div>
                    </div>
                </div>
