...
function getBscPadProjects(){
    try{
        fetch('https://api.fantomstarter.io/fantomstarter/get/projects')
                        ...
                        <div class="card-body p-3">
                            <ul class="list-group">
                                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                                    <div class="me-2">
                                        <img src="${data.projects[i].logo_image_url}" style="width: 40px;" alt="">
                                    </div>
                                    <div class="d-flex align-items-start flex-column justify-content-center">
                                        <h6 class="mb-0 text-sm">${data.projects[i].name}</h6>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="text-sm text-bold text-dark"> 1 ${data.projects[i].ido_token_symbol} = ${data.projects[i].ratio_paytoken_per_idotoken} ${data.projects[i].pay_token_symbol}</div>
                            <div class="row justify-content-md-center mt-2">
                                ${data.projects[i].whitelisted_count != "0" ? `<span class="badge bg-gradient-danger col-11">დამთავრებულია</span>` : `<span class="badge bg-gradient-success col-11">TBA</span>`}
                            </div>
                        </div>
                    </div>
                </div>
