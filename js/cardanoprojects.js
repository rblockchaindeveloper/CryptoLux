/* fetch('https://raw.githubusercontent.com/ray-network/cardano-verified/main/projects/list.json')
...
let twitterIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#1DA1F2" style="cursor: pointer;" class="bi bi-twitter" viewBox="0 0 16 16">
        ...
        data.data.forEach(t => {
            ...
            <tr>
                ...
                <div class="d-flex px-2 py-1">
                    ...
                    <img src="https://raw.githubusercontent.com/ray-network/cardano-verified/main/projects/icon/${t.icon}" style="width: 25px;" class="mt-1" alt="">
                    </div>
                    <div class="d-flex flex-column justify-content-center">
                    <h6 class="mb-0 text-sm"> <a target="_blank" href="${t.url}">${t.name}</a></h6>
                    </div>
                </div>
                </td>
                <td class="align-middle">
                <p class="text-sm font-weight-bold mb-0">${t.category}</p>
                </td>
                <td class="align-middle text-center">
                <div class="text-wrap text-start" style="width: 50rem;">
                ${t.description}
                </div>
                </td>
                <td class="align-middle text-center">
                <p class="text-sm font-weight-bold mb-0"><a target="_blank" href="${t.twitter}">${twitterIcon}</a></p>
                </td>
            </tr>
            `

            cardanoProjectsList.innerHTML += content;
            counter += 1;
        })
    })
}
