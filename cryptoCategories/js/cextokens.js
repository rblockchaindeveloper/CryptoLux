...
function getTopCryptos(){
    fetch('https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&category=centralized-exchange-token-cex&order=market_cap_desc&per_page=100&page=1&sparkline=false&price_change_percentage=1h%2C24h%2C7d')
        ...
        data.forEach(coin =>{
            ...
            <tr>
                ...
                <div class="d-flex px-2 py-1">
                    ...
                    <h6 class="mb-0 text-sm"> <a target="_blank" href="https://www.coingecko.com/en/coins/${coin.id}">${coin.name} (${(coin.symbol).toUpperCase()})</a></h6>
                    </div>
                </div>
                </td>
                ...
                <td class="align-middle text-center">
                <p class="text-sm font-weight-bold">${priceChange7Percent}</p>
                </td>
                <td class="align-middle text-center">
                <p class="text-sm font-weight-bold mb-0">$${formatCash(coin.total_volume)}</p>
                </td>
                <td class="align-middle text-center">
                <p class="text-sm font-weight-bold mb-0">$${formatCash(coin.market_cap)} ${mCapPercent}</p>
                </td>
            </tr>
            `

            topcryptolist.innerHTML += content;
        })
